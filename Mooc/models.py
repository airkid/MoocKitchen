...
class QuizQuestion(models.Model):
    ...
    image_a = models.FileField(upload_to='files/quizimg/ChooseImg',blank=True)
    option_b = models.CharField(max_length=50)
    image_b = models.FileField(upload_to='files/quizimg/ChooseImg',blank=True)
    #image_b = models.CharField(blank=True, max_length=100, null=True)
    option_c = models.CharField(max_length=50)
    image_c = models.FileField(upload_to='files/quizimg/ChooseImg',blank=True)
    #image_c = models.CharField(blank=True, max_length=100, null=True)
    option_d = models.CharField(max_length=50)
    image_d = models.FileField(upload_to='files/quizimg/ChooseImg',blank=True)
    ...
    image = models.FileField(upload_to='files/quizimg',blank=True);
    # 用于临时存储答案
