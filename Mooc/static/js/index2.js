...
// EMAIL UNIQUENESS
function email_uniqueness(email) {
...
function sign_up_form_btn_check() {
...
$(document).on('submit', '.reset-pw-form', function (event) {
    var email = $('.reset-pw-email').val();
    verify_email(email);
    return false;
});

function verify_email(email) {
    var $form = $('.reset-pw-form');
    $.post("/email_validate", {email: email}, function (data) {
...
$(document).on('keypress keydown keyup', '#external-feedback-form', function () {
    var save_btn = $('#external-feedback-form .btn');
    var email = $('#external-feedback-form .email-field').val();
    var msg = $('#external-feedback-form .msg-field').val();
    var email_cond = re.test(email);
    var msg_cond = msg.length > 0;
    //console.log(email_cond + '_' + msg_cond);
...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        var sliderOffset = $('.caption-inner').offset().top + 230;
